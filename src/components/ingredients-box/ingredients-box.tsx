...
function IngredientsBox(props: any) {
  ...
  const bun = bunData.map((item: any) => <IngredientsItem image={item.image} name={item.name} price={item.price}/>);
  const sauce = sauceData.map((item: any) => <IngredientsItem image={item.image} name={item.name} price={item.price}/>);
  const main = mainData.map((item: any) => <IngredientsItem image={item.image} name={item.name} price={item.price}/>);
