...
export const FEED_WS_CONNECTION_GET_MESSAGE: 'FEED_WS_CONNECTION_GET_MESSAGE' = 'FEED_WS_CONNECTION_GET_MESSAGE';
export const FEED_WS_CONNECTION_SEND_MESSAGE: 'FEED_WS_CONNECTION_SEND_MESSAGE' = 'FEED_WS_CONNECTION_SEND_MESSAGE';