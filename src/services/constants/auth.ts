...
export const GET_PASSCODE_REQUEST: "GET_PASSCODE_REQUEST" = "GET_PASSCODE_REQUEST";
export const GET_PASSCODE_SUCCESS: "GET_PASSCODE_SUCCESS" = "GET_PASSCODE_SUCCESS";
export const GET_PASSCODE_ERROR: "GET_PASSCODE_ERROR" = "GET_PASSCODE_ERROR";
